#!/usr/bin/env python3
"""
HTTP Client with TCP Sockets
Usage: python client.py <URL> [output_file]
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python client.py <URL> [output_file]")
        print("\nExamples:")
        print("  python client.py http://localhost:8080/")
        print("  python client.py http://localhost:8080/test.txt")
        print("  python client.py http://localhost:8080/image.png output.png")
